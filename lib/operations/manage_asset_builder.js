    ...
    _createClass(ManageAssetBuilder, null, {
        assetCreationRequest: {
            ...
            value: function assetCreationRequest(opts) {
                ...
                var ext = new xdr.AdditionalAssetFields({
                    expirationDate: UnsignedHyper.fromString(opts.expirationDate),
                    trailingDigitsCount: Number(opts.trailingDigitsCount),
                    ext: new xdr.AdditionalAssetFieldsExt(xdr.LedgerVersion.emptyVersion())
                });

                attrs.ext = new xdr.AssetCreationRequestExt.addAssetBalancePrecision(ext);
        ...
        assetUpdateRequest: {
            ...
            value: function assetUpdateRequest(opts) {
                ...
                attrs.ext = new xdr.AssetUpdateRequestExt.addExpirationDateToAsset(UnsignedHyper.fromString(opts.expirationDate));
                    ...
                    case xdr.ManageAssetAction.createAssetCreationRequest():
                        {
                            ...
                            result.expirationDate = request.ext().additionalFields().expirationDate().toString();
                            result.trailingDigitsCount = request.ext().additionalFields().trailingDigitsCount().toString();
                            break;
                        }
