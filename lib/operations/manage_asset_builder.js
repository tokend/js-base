    ...
    _createClass(ManageAssetBuilder, null, {
        assetCreationRequest: {
            ...
            value: function assetCreationRequest(opts) {
                ...
                var assetCreationRequest = new xdr.ManageAssetOpCreateAssetCreationRequest({
                ...
                var requestUnionSwitch = new xdr.ManageAssetOpRequest.createAssetCreationRequest(assetCreationRequest);
        ...
        assetUpdateRequest: {
            ...
            value: function assetUpdateRequest(opts) {
                ...
                var assetUpdateRequest = new xdr.ManageAssetOpCreateAssetUpdateRequest({
            ...
            value: function manageAssetToObject(result, attrs) {
                ...
                switch (attrs.request()["switch"]()) {
                    ...
                    case xdr.ManageAssetAction.createAssetUpdateRequest():
                        {
                            var request = attrs.request().createAssetUpdateRequest().updateAsset();
